...
class pendingOrdersWidgetCompleted extends StatefulWidget {
  CompletedTasksModel data;
  pendingOrdersWidgetCompleted({super.key, required this.data});

  @override
  State<pendingOrdersWidgetCompleted> createState() => _pendingOrdersWidgetCompletedState();
}

class _pendingOrdersWidgetCompletedState extends State<pendingOrdersWidgetCompleted> {
  List<int> rgba = [];
