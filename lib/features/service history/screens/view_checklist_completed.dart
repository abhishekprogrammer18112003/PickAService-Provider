...
class ViewCheckListScreenCompleted extends StatefulWidget {
  AcceptedOrdersModel arguments;
  ViewCheckListScreenCompleted({super.key, required this.arguments});

  @override
  State<ViewCheckListScreenCompleted> createState() => _ViewCheckListScreenCompletedState();
}

class _ViewCheckListScreenCompletedState extends State<ViewCheckListScreenCompleted> {
